...
const ActivitiesTest = () => {
  ...
  async function findActivity(id) {
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/activitiesapi/activities/${id}`, {
      methods: "GET",
      headers: {
  ...
  async function joinActivity(jason) {
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/activitiesapi/activities/addAttendee`, {
      method: "PUT",
      body: JSON.stringify({
  ...
  async function leaveActivity(jason) {
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/activitiesapi/activities/leaveActivity/`, {
      method: "DELETE",
      body: JSON.stringify({
        activityID: jason.activityID,
        userID: jason.userID
  ...
  async function updateActivity(jason) {
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/activitiesapi/activities/updateActivity`, {
      method: "PUT",
      body: JSON.stringify({
        id: jason.activityID,
  ...
  /*async function deleteUser(id) {
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/activitiesapi/deleteActivities/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async function deleteActivity(jason) {
    ...
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/activitiesapi/activities/deleteActivity/`, {
      method: "DELETE",
      body: JSON.stringify({
        activityID: jason.activityID,
        hostID: jason.hostID,

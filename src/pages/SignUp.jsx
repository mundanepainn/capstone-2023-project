...
import { Button, TextField, Grid, Paper, Typography } from "@mui/material"; // Import Material-UI components
...
const SignUp = () => {
  ...
  const handleSignUp = (e) => {
    ...
    e.preventDefault(); // Prevent the default form submission
        ...
        axios.post("https://us-central1-wedo-1a85a.cloudfunctions.net/api/cognito/signUp",{
        "username":email,
        "password": pass
    ...
    navigate("/signup/userCreation"); // Navigate to the User Creation Page
  };

...
const UsersTest = () => {
  ...
  async function updateUser(jason) {
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/testapi/users/${jason.id}`, {
      method: "PUT",
      body: JSON.stringify({
        id: jason.id,
        name: jason.name,
  ...
  async function deleteUser(id) {
    const res = await fetch(`https://us-central1-wedo-1a85a.cloudfunctions.net/api/testapi/deleteUser/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function usersList() {
    useEffect(function effectFunction() {
      async function fetchUsers() {
        const response = await fetch("https://us-central1-wedo-1a85a.cloudfunctions.net/api/testapi/", {
          methods: "GET",
          headers: {
            "Content-Type": "application/json",
          },

...
function WedoNavbar() {
    ...
    return (
        ...
        <List>
        <ListItem>
        <Button sx={wedonavpopper} onClick={() => navigate("/hosting") /* Replace with Explore page*/}>Hosting</Button>
        </ListItem>
        <ListItem>
        <Button sx={wedonavpopper} onClick={() => navigate("/") /* Replace with Explore page*/}>Joining</Button>
        </ListItem>
        </List>
        </Popper>
        <BottomNavigation  className="wedonav" sx={{position:'fixed',bottom:'0',left:'0',right:'0',backgroundColor:'white',height:80}}>
            <IconButton sx={wedonavtext} onClick={() => navigate("/") /* Replace with Explore page*/}>
                <SearchIcon color= "action" className="wedonavtext"></SearchIcon>
            </IconButton>
            <IconButton  sx={wedonavtext} onClick={() => navigate("/") /* Replace with Messages page*/}>
            ...
            <IconButton  sx={wedonavtext} onClick={() => navigate("/") /* Replace with "get user with id" profile page*/}>

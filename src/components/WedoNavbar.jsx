...
function WedoNavbar() {
    ...
    return (
        ...
        <List>
        <ListItem>
        <Button sx={wedonavpopper} onClick={() => navigate("/hosting/displayCategories")}>Create</Button>
        </ListItem>
        <ListItem>
        <Button sx={wedonavpopper} onClick={() => navigate("/hosting") }>Hosting</Button>
        </ListItem>
        <ListItem>
        <Button sx={wedonavpopper} onClick={() => navigate("/attending") /* Replace with Explore page*/}>Joined</Button>
        </ListItem>
        </List>
        </ClickAwayListener>
        </Popper>
        ...
        <BottomNavigation  className="wedonav" sx={{position:'fixed',bottom:'0',left:'0',right:'0',backgroundColor:'white',height:80}}>
            ...
            <IconButton  sx={wedonavtext} onClick={() => navigate("/chat") /* Replace with Messages page*/}>
